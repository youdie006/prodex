...
- [x] Add immutable result artifact verification by storing a result artifact sha256 on the result record and rejecting `bridge_fetch_result_artifact` if the artifact changed after finalization.
