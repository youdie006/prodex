...
try {
  ...
  const unknownSubcommandCases = [
    ...
    },
    {
      ...
      expected: "Unknown pro browser subcommand: verify. Expected one of: login, ask, smoke, check, models, projects, project-delete, chats, chat-delete, reset, recover. Run `prodex pro browser --help`."
    },
    {
      args: ["pro", "verify"],
